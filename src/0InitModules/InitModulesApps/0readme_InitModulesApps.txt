...
Updating of basic source project dependencies for IGLib.Apps.
  * Runs /scripts/UpdateDependencyRepos.ps1
...
<ItemGroup>
	<ProjectReference Include="..\0InitModules\InitModulesScriptingCs\InitModulesScriptingCs.csproj"
