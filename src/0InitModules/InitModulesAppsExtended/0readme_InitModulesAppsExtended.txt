...
Updating of EXTENDED (+ basic) source project dependencies for IGLib.Apps.
  * Runs /scripts/UpdateDependencyReposExtended.ps1
    * Clones/uppdates basic repos such as IGLibCore
    * Also clones/updates external repos in ../../_external


This project just performs common initialization tasks for the projects that reference it, such as running scripts to clone source repositories of dependencies referenced via source code projects.
...
<ItemGroup>
	<ProjectReference Include="..\0InitModules\InitModulesScriptingCsExtended\InitModulesScriptingCsExtended.csproj"
