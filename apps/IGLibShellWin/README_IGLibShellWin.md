...
This will be a **command-line application** where various demonstrations and utilities can be run using installed commands. Commands can include Windows Forms-based functionality, and the application is **not cross-platform**.
